...
{'study_design': "Revue systématique de la littérature basée sur une recherche multi-bases de données (trois bases), utilisant des requêtes à deux niveaux (requête centrale primaire et requête supplémentaire élargie), suivie d'un tamisage en deux étapes (titres/résumés puis texte intégral) réalisé indépendamment par deux évaluateurs (D.L. et W.L.), avec résolution des désaccords par un troisième évaluateur senior (L.X.)", 'intervention': None, 'control': None, 'primary_outcomes': ['Classification des études incluses selon le cadre perception-décision-exécution', "Synthèse des caractéristiques clés des études incluses (tâche, anatomie cible, modalité d'imagerie, taille du jeu de données, type de validation, métriques d'évaluation, niveau de maturité clinique)"], 'secondary_outcomes': ["Identification des défis critiques freinant la traduction clinique (rareté des données, biais, écarts de généralisation, facteurs humains, défis d'intégration, défis réglementaires et éthiques)", "Élaboration d'orientations futures pour la recherche"], 'statistical_methods': [], 'duration': 'Publications couvrant la période de janvier 2015 à décembre 2025', 'setting': 'Revue de littérature portant sur des études de chirurgie orthopédique assistée par IA (perception, décision, exécution)'}

## Résultats

{'quantitative': [{'outcome': 'Nombre de publications incluses dans la revue', 'value': '89', 'unit': 'études', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Literature Screening Procedure)', 'source_quote': 'In the end, we identified 89 publications that met all our inclusion criteria.'}, {'outcome': 'Rapports évalués pour éligibilité', 'value': '107', 'unit': 'rapports', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Included Studies / Screening)', 'source_quote': 'Reports assessed for eligibility (n=107)'}, {'outcome': 'Enregistrements exclus manuellement', 'value': '11950', 'unit': 'enregistrements', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Included Studies)', 'source_quote': 'Records excluded by human(n=11,950)'}, {'outcome': 'Somme des comptages de catégories (Figure 3), du fait de la classification multi-catégorielle de certaines études', 'value': '94', 'unit': 'classements catégoriels', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Literature Screening Procedure)', 'source_quote': 'It should be noted that while the total number of unique included studies is 89, five studies were classified into multiple functional categories because their proposed frameworks explicitly bridge multiple domains. Consequently, the sum of the category counts in Figure 3 amounts to 94.'}, {'outcome': 'Doublons supprimés (requête centrale primaire)', 'value': '1591', 'unit': 'enregistrements', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Included Studies)', 'source_quote': 'Duplicates removed from primary core query results: n=1591'}, {'outcome': 'Doublons supprimés (requête supplémentaire élargie)', 'value': '2683', 'unit': 'enregistrements', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Included Studies)', 'source_quote': 'Duplicates removed from expanded supplementary query results:n=2683'}, {'outcome': 'Doublons supprimés après fusion des résultats des deux requêtes', 'value': '1618', 'unit': 'enregistrements', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Methods (Included Studies)', 'source_quote': 'Duplicates removed after merging primary and expanded query results:n=1618'}], 'qualitative_findings': ["Les systèmes de perception ont évolué de modèles de segmentation basés sur CNN vers des architectures transformer avancées, supportant la fusion multi-modale et la quantification d'incertitude", "Les systèmes de décision sont passés de méthodes rigides basées sur des règles à des modèles pilotés par les données pour la planification chirurgicale, la prédiction de risque et l'optimisation continue des résultats", "Les systèmes d'exécution ont évolué d'outils de navigation passive vers des systèmes d'assistance robotique active avec des capacités d'adaptation en temps réel", "La plupart des modèles d'IA actuels sont entraînés sur des jeux de données limités, manquant de généralisabilité entre sites anatomiques, modalités d'imagerie et populations de patients", "La faible interprétabilité (fonctionnement en 'boîte noire') reste un défi majeur limitant la confiance clinique", "Peu d'études examinent comment les systèmes de perception, décision et exécution fonctionnent ensemble, laissant une vision fragmentée du domaine", 'Un écart de généralisation existe entre les expériences de laboratoire contrôlées et la pratique clinique réelle, notamment en environnement de bloc opératoire bruité et dynamique', "Le manque de boucles de rétroaction entre les systèmes d'exécution et de perception constitue le défi d'intégration le plus critique", 'Des défis réglementaires et éthiques significatifs subsistent, incluant la sécurité des patients, la confidentialité des données et la responsabilité légale'], 'main_findings': ["Le domaine évolue rapidement d'innovations techniques isolées vers des systèmes intégrés couvrant l'ensemble du flux de travail perception-décision-exécution", "Les technologies d'IA ont mûri de manière significative pour améliorer la précision chirurgicale et les soins personnalisés", "L'adoption clinique généralisée reste contrainte par des barrières critiques de traduction : rareté des données, écarts de généralisation entre contextes cliniques divers, et manque d'intégration de systèmes de bout en bout", "Les systèmes d'assistance chirurgicale en boucle fermée sont identifiés comme la prochaine direction clé de développement"]}

## Conclusions

La revue systématique de 89 études récentes met en évidence un changement de paradigme clair dans la chirurgie orthopédique assistée par IA : le domaine s'oriente rapidement vers des systèmes intégrés couvrant l'ensemble du flux perception-décision-exécution Malgré la maturation des technologies d'IA pour améliorer la précision chirurgicale et les soins personnalisés, l'adoption clinique généralisée demeure limitée par des barrières critiques : rareté des données, écarts de généralisation entre contextes cliniques, et manque d'intégration de systèmes de bout en bout La recherche future doit s'orienter vers des modèles de fondation conscients de l'incertitude et des plateformes robotiques cognitives caractérisées par des boucles de rétroaction bidirectionnelles L'objectif final n'est pas de remplacer l'expertise humaine, mais de forger une collaboration humain-IA synergique qui augmente la performance peropératoire et améliore fondamentalement les résultats pour les patients
