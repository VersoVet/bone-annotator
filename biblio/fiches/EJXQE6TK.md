...
{'study_design': "Système en deux étapes : (1) un modèle YOLO entraîné pour distinguer les structures osseuses d'autres objets à partir d'un nombre limité d'images contenant des os de diverses espèces (y compris hors du jeu de données principal) ; (2) le modèle YOLO entraîné a été utilisé pour scanner des images d'os placés séquentiellement sur une table sous différents angles, et les images recadrées ont été enregistrées sous la classe animale correspondante", 'intervention': "Collecte systématique de données garantissant une représentation équilibrée entre toutes les classes : exactement 2744 images acquises pour chaque combinaison os-espèce (9 classes), avec capture d'images sous différents angles, conditions d'éclairage et positions ; images capturées en résolution 720p, nettoyées pour retirer les valeurs aberrantes, puis techniques d'augmentation de données appliquées (ajustement de luminosité, rotation, recadrage, retournement horizontal)", 'control': None, 'primary_outcomes': ["Capacité du système à identifier le type d'os et l'espèce animale correspondante"], 'secondary_outcomes': [], 'statistical_methods': [], 'duration': None, 'setting': "Laboratoire d'Anatomie de la Faculté de Médecine Vétérinaire de l'Université Erciyes"}

## Résultats

{'quantitative': [{'outcome': 'Différence des réponses selon le niveau académique', 'value': 'p > 0.05', 'unit': None, 'confidence_interval': None, 'p_value': 'p > 0.05', 'effect_size': None, 'source_section': 'Results, paragraphe 1', 'source_quote': 'When the responses of the participating students were analyzed according to academic level, no statistically significant differences were found (p > 0.05) (Table 7).'}, {'outcome': "Nombre d'étudiants participants à l'enquête", 'value': '150', 'unit': 'étudiants en médecine vétérinaire', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Results, paragraphe 2', 'source_quote': 'The 5-point Likert scale analysis presented as a horizontal bar chart in Figure 12 and Table 8 comprehensively illustrates the responses of 150 veterinary medicine students regarding the Smart Osteology application.'}, {'outcome': "Taux de réponses positives global (tous items de l'enquête)", 'value': '> 90', 'unit': '%', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Results, paragraphe 2', 'source_quote': 'The analysis results show that positive response rates exceeded 90% across all survey items'}, {'outcome': "Satisfaction la plus élevée - catégorie 'facilité d'utilisation de l'application'", 'value': '98.0', 'unit': '%', 'confidence_interval': None, 'p_value': None, 'effect_size': None, 'source_section': 'Results, paragraphe 2', 'source_quote': 'with the highest satisfaction reported in the "ease of use of the application" category (98.0%).'}], 'qualitative_findings': ['Aucune différence statistiquement significative dans les réponses des étudiants selon le niveau académique', "L'application Smart Osteology a été globalement bien reçue par les étudiants en médecine vétérinaire, avec un fort niveau de satisfaction sur l'ensemble des items de l'enquête"], 'main_findings': ['Les réponses des étudiants ne varient pas significativement selon le niveau académique (p > 0.05)', "Plus de 90% de réponses positives sur tous les items de l'enquête Likert à 5 points", "La facilité d'utilisation de l'application est l'aspect le plus apprécié, avec 98.0% de satisfaction"]}

## Conclusions

This study successfully demonstrated the applicability of deep learning techniques in classifying certain long bones from selected domestic animal species Bone detection was performed using the YOLO algorithm, and species and bone name classification were achieved with high accuracy through CNN and ResNet34 architectures The obtained accuracy rate of 97.6% confirms that the developed system is a reliable tool for both educational and forensic purposes This work offers a novel and versatile digital solution applicable to fields such as veterinary anatomy education, forensic science, archaeology, and biological anthropology
